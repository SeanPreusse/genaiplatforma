const translation = {
  ...
  welcome: '👋 Welcome to Coherence, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Coherence Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Coherence',
  invalid: 'The link has expired',
  explore: 'Explore Coherence',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Coherence and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Coherence Enterprise license for your workspace has expired. Please contact your administrator to continue using Coherence.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Coherence license server. Please contact your administrator to continue using Coherence.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Coherence Enterprise license for your workspace is inactive. Please contact your administrator to continue using Coherence.',
}
