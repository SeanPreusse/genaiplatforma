const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Coherence account',
    langGeniusAccountTip: 'Your Coherence account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Coherence to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Coherence allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Coherence\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Coherence {{version}} is now available.',
    latestAvailable: 'Coherence {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
